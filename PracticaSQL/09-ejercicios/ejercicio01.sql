...
CREATE TABLE clientes(
	...
	CONSTRAINT fk_cliente_vendedor FOREIGN KEY(venedor_id) REFERENCES vendedores(id)
)ENGINE=InnoDB;
...
CREATE TABLE encargos(
	...
	CONSTRAINT fk_encargo_ciente FOREIGN KEY(cliente_id) REFERENCES clientes(id),
...
#COCHES
INSERT INTO coches VALUES(NULL, 'Renaul clio', 'Renault', 12000, 13);
...
#GRUPOS
INSERT INTO grupos VALUES(NULL, 'Vendedores A', 'Cartagena de Indias');
INSERT INTO grupos VALUES(NULL, 'Vendedores B', 'Cartagena de Indias');
INSERT INTO grupos VALUES(NULL, 'Directores mecánicos', 'Cartagena de Indias');
INSERT INTO grupos VALUES(NULL, 'Vendedores A', 'Medellín');
INSERT INTO grupos VALUES(NULL, 'Vendedores B', 'Medellín');
INSERT INTO grupos VALUES(NULL, 'Vendedores C', 'Cali');
INSERT INTO grupos VALUES(NULL, 'Vendedores A', 'Bogotá');
INSERT INTO grupos VALUES(NULL, 'Vendedores B', 'Pereira');
INSERT INTO grupos VALUES(NULL, 'Vendedores C', 'Sincelejo');
#VENDEDORES
...
#CLIENTES
INSERT INTO clientes VALUES(NULL, 1, 'Construciones Diaz Inc', 'Cartagena de Indias', 24000, CURDATE());
INSERT INTO clientes VALUES(NULL, 1, 'Frutería Antonio Inc', 'Medellín', 40000, CURDATE());
INSERT INTO clientes VALUES(NULL, 1, 'Imprenta Martinez Inc', 'Cali', 32000, CURDATE());
INSERT INTO clientes VALUES(NULL, 1, 'Jesus Colchones Inc', 'Bogotá', 96000, CURDATE());
INSERT INTO clientes VALUES(NULL, 1, 'Bar Pepe Inc', 'Pereira', 170000, CURDATE());
INSERT INTO clientes VALUES(NULL, 1, 'Tienda PC Inc', 'Sincelejo', 245000, CURDATE());
#ENCARGOS
